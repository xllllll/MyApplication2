...
public class oyun extends AppCompatActivity implements SensorEventListener {
    ...
    private final float CHANGE_INTERVAL = 2;
...
//**************************************************************************************************
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if(getIntent().getStringExtra(MainActivity.DIFFICULTY_MESSAGE) != null)
        //{
            //Use difficultyRating adds speed to the player and also the multiplier
           // difficultyRating = ((Integer.parseInt(getIntent().getStringExtra(MainActivity.DIFFICULTY_MESSAGE)) / 20));
        //}
        difficultyRating = (200 / 20);
    ...
    private boolean powerUpActivity()
    {
                ...
                player.myY + player.mySize <= powerUp.myY + powerUp.mySize *2)
        {
            ...
            if(player.number == powerUp.number)
            {
                ...
                chainScore += 2; //TODO Change this to a global variable, power up score value
...
//**************************************************************************************************
    ...
    private void displayWelcome()
    {
        ...
        editor.putInt("coins", myInt + playerScore);
      //  TextView coin = (TextView) findViewById(R.id.textView);
//        coin.setText("Coins : " + myInt + playerScore);
        editor.commit();
